            ...
            <form action="{{ route('settings.update') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        <input type="number" 
                               ...
                               value="{{ $settings['discount_percentage']->value ?? 12 }}"
                               min="0"
                               max="100"
                               step="0.01"
                               required
                ...
                <div class="mb-6">
                    ...
                    <select name="update_mode" 
                        ...
                        <option value="check_date" {{ ($settings['update_mode']->value ?? 'check_date') == 'check_date' ? 'selected' : '' }}>
                            Verificar fecha (solo actualizar si FecUlMo es más reciente)
                        </option>
                        <option value="force_all" {{ ($settings['update_mode']->value ?? '') == 'force_all' ? 'selected' : '' }}>
                            Forzar todos (actualizar siempre)
                        </option>
                        <option value="manual" {{ ($settings['update_mode']->value ?? '') == 'manual' ? 'selected' : '' }}>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                           name="default_shop_code" 
                           id="default_shop_code"
                           value="{{ $settings['default_shop_code']->value ?? '0001' }}"
                           required
