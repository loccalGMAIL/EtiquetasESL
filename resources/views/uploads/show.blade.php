        ...
        <div class="p-6">
            <div class="flex justify-between items-start">
                ...
                <div class="text-right">
                    ...
                    @endphp
                    <span class="px-3 py-1 inline-flex text-sm leading-5 font-semibold rounded-full {{ $statusColors[$upload->status] }}">
                        ...
                        @forelse($logs as $log)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    ...
                                    <div class="text-green-600">Desc: ${{ number_format($log->precio_calculado, 2) }}</div>
                                    @if($log->precio_anterior_eretail)
                                        <div class="text-xs text-gray-400">Anterior: ${{ number_format($log->precio_anterior_eretail, 2) }}</div>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
